     ...
     className='bg-white shadow-md hover:shadow-lg border border-gray-100 rounded-2xl p-6 '>
      <div className='flex flex-col md:flex-row md:items-start md:justify-between gap-4'>
        ...
        <div className='flex flex-col items-start md:items-end gap-2'>
          <span className={`text-xs font-semibold px-3 py-1 rounded-full capitalized ${
      ...
      <div className='border-t border-gray-300 pt-3 mt-3'>
                 ...
                 <div className='border-t pt-3 mt-3 flex justify-between items-center font-semibold text-sm border-gray-300'>
