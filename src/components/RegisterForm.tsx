    ...
    <div className='flex flex-col justify-center items-center min-h-screen px-6 py-10 relative'>
        ...
        transition={{duration:0.6}}
          ...
          className='flex flex-col w-full max-w-sm gap-5'>
            ...
            <button className='w-full flex items-center justify-center gap-3 py-3 rounded-xl font-medium border border-black hover:bg-gray-200 cursor-pointer'>
                <Image alt='' src={googleImage} width={20} height={20}/>
                Continue with Google
            </button>
          </motion.form>

          <p className='flex items-center text-sm mt-6 gap-1 cursosr-pointer'>Already have an accoutn ? <span className='text-blue-600'>Sign in</span></p>
        </div>
  )
}
